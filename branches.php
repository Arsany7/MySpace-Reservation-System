...
require('database.php');
   ...
   $query=mysqli_query($database_connection,"select branch_id, location, count(*) from branch Natural Join `table` group by branch_id"); 
   ...
   if($count!=0){       
    ...
    <thead class="thead-dark">    
          ...
          <th  scope="col"> <font face="Arial">Number Of Tables</font> </th> 
        </thead>
        </tr>

        ';
        while($row = mysqli_fetch_assoc($query)){
      $field1name = $row["branch_id"];
